    ...
    <Link to={`/blog/${id}`}>
      <div className="p-4 border-b border-slate-200 pb-4 w-screen max-w-screen-md cursor-pointer mb-10 backdrop-blur-3xl backdrop-brightness-150 rounded-t-md ">
        <div className="flex">
          ...
          <div className="font-extralight pl-2 text-sm flex justify-center flex-col text-white">
            {authorName}
          </div>
...
export const Avatar = ({
  ...
  return (
    <div
      className={`relative inline-flex items-center justify-center overflow-hidden bg-zinc-500 rounded-full ${
