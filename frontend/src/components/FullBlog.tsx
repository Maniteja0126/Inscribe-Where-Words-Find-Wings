...
export const FullBlog = ({ blog }: { blog: Blog }) => {
  return (
    <div className="min-h-screen h-full w-full flex md:items-center md:justify-center bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden">
      {/* <Spotlight
      ...
      <div className="z-20 w-full">
        <div>
          ...
          <div className="flex justify-center mt-28">
            <div className="grid grid-cols-12 px-5 w-full max-w-screen-xl pt-12 gap-y-20 gap-x-20 h-fit mb-20">
              ...
              <div className="lg:col-span-4 col-span-12">
                <div>
                  <div className="text-zinc-400 text-lg">Author</div>
